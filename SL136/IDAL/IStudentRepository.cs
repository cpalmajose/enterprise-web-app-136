namespace IRepository
{
    ...
    public interface IStudentRepository
    {
        ...
        //// added
        List<CapeReview> GetCapeReviews(string studentId, ref List<string> errors);

        void DeleteCapeReview(string studentId, int schedule_id, ref List<string> errors);

        ////List<Grade> GetStudentGrades(string studentId, ref List<string> errors);
    }
}
