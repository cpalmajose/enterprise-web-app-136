namespace Repository
{
    ...
    public class StudentRepository : BaseRepository, IStudentRepository
    {
        ...
        // added
        private const string GetStudentCapeReviews = "spGetStudentCapeReviews";
        private const string DeleteCapeReviewInfoProcedure = "spDeleteCapeReviewInfo";
        ...
        public void DeleteCapeReview(string studentId, int schedule_id, ref List<string> errors)
        {
            var conn = new SqlConnection(ConnectionString);
            try
            {
                var adapter = new SqlDataAdapter(DeleteCapeReviewInfoProcedure, conn)
                {
                    SelectCommand =
                    {
                        CommandType = CommandType.StoredProcedure
                ...
                adapter.SelectCommand.Parameters["@student_id"].Value = studentId;
                adapter.SelectCommand.Parameters["@course_schedule_id"].Value = schedule_id;
